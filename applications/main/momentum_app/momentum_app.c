...
bool momentum_app_apply(MomentumApp* app) {
    ...
    if(app->show_slideshow) {
        ...
        popup_set_header(app->popup, "重启中...", 64, 26, AlignCenter, AlignCenter);
        popup_set_text(app->popup, "应用更改中...", 64, 40, AlignCenter, AlignCenter);
        ...
        asset_packs_free();
        popup_set_header(app->popup, "重新加载中...", 64, 26, AlignCenter, AlignCenter);
        popup_set_text(app->popup, "应用资产包...", 64, 40, AlignCenter, AlignCenter);
