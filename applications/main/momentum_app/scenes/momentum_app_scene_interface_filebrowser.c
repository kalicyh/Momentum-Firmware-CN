...
void momentum_app_scene_interface_filebrowser_on_enter(void* context) {
    ...
    variable_item_set_current_value_text(item, momentum_settings.sort_dirs_first ? "开启" : "关闭");
    ...
    variable_item_set_current_value_text(item, momentum_settings.show_hidden_files ? "开启" : "关闭");
    ...
    variable_item_set_current_value_text(item, momentum_settings.show_internal_tab ? "开启" : "关闭");
